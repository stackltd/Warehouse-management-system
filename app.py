...
from utils import str_corr, load_file, div_string, get_fields
...
def initialize():
    ...
    if fields_from_base is None or base_is_changed:
        ...
        app.extensions["fields_from_base"] = json.dumps(get_fields(base))
...
def stock():
    ...
    fields, fields_params, fields_order, statuses, url_for_redirect_from_photo = (
        json.loads(app.extensions["fields_from_base"])
    )
